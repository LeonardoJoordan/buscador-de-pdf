# Flatpak do BuscadorPDF

O manifesto `com.leobelisario.BuscadorPDF.yaml` segue o modelo fornecido e usa
...
flatpak-builder --repo=repo --force-clean build-dir com.leobelisario.BuscadorPDF.yaml
flatpak build-bundle repo BuscadorPDF.flatpak com.leobelisario.BuscadorPDF
flatpak install --user --reinstall BuscadorPDF.flatpak
flatpak run com.leobelisario.BuscadorPDF
```
...
`~/.var/app/com.leobelisario.BuscadorPDF/data/index.db`. A primeira execução cria
...
```sh
flatpak override --user --filesystem=/mnt/documentos:ro com.leobelisario.BuscadorPDF
```
